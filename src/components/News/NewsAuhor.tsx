...
const NewsAuhor = ({
    ...
    return (
        <div className="flex items-start gap-4 p-4 sm:p-6 md:p-14 rounded #F2F5F9">
            <img className="rounded-full aspect-square h-auto" src={avatarUrl} alt={name} width={64} height={64} />
